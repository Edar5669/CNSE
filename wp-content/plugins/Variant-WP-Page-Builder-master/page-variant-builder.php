...
<body mrv_namespace="medium.rare.stack" mrv_contentTarget=".main-container" mrv_navTarget=".nav-container" mrv_footerTarget=".main-container" <?php body_class(); ?>>
	...
	<div class="vhc vhq">
		...
		<div class="vhb">
			<img alt="Variant HTML Page Builder" src="<?php echo VARIANT_PAGE_BUILDER_PATH; ?>img/full-logo.png">
		</div>
		
		<div class="vha">
			<a target="_blank" href="http://www.mediumra.re/"><img class="vlb" alt="Variant HTML Page Builder" src="<?php echo VARIANT_PAGE_BUILDER_PATH; ?>img/mrare.png"></a>
			<a target="_blank" href="http://www.tommusrhodus.com/"><img class="vlb" alt="Variant HTML Page Builder" src="<?php echo VARIANT_PAGE_BUILDER_PATH; ?>img/tr-logo-white.png"></a>
	...
	<div class="vhv vba">
		...
		<div class="vjc vjf vle">
			...
			<div class="vlf">
				<ul>
					<li data-mrv-tooltip="Pages" class="vlg vfp"><i class="material-icons">&#xE24D;</i></li>
					<li data-mrv-tooltip="Page Content" class="vlh vhr"><i class="material-icons">&#xE02F;</i></li>
					<li class="vlj"><span class="oi" data-glyph="brush"></span></li>
					<li class="vpo"><span class="oi" data-glyph="browser"></span></li>
				</ul>
			...
			<div class="vkm vjz">
				...
				<div class="vlo vlp">
					...
					<div class="vhs vgc vqg">Save Page As</div>
					<div class="vmd">
					
						<div class="vfw empty-vfw"></div>
					
					</div>
					
					<div class="vhs vpt" title="New Page"></div>
				...
				<div class="vlv vlp vhr">
					...
					<div class="vmd">
						...
						<div class="vho">
							<span class="vly">Navigation</span>
							<div class="vfj"></div>
						</div>
				
						<div class="vho">
							<span class="vly">Footer</span>
							<div class="vdm"></div>
						</div>
	...
	<div class="vqc vin vds">
		<div class="vfa">
			<span class="vjl vqe"></span>
			<i class="variant-icon variant-close-circle vex"></i>
		</div>
		...
		<div class="vjp">
			<div class="vhs vak vix vqd vex"></div>
			<div class="vhs vak vix vex">Cancel</div>
		</div>
	...
	<div class="vge vin vds">
		...
		<div class="vjp">
			<div class="vhs vex val vpu vil">Cancel</div>
	...
	<div class="global-vfr vin vkf">
		<img alt="Logo" src="<?php echo VARIANT_PAGE_BUILDER_PATH; ?>img/full-logo.png">
		<div class="vew">
		...
		<img alt="Medium Rare" src="<?php echo VARIANT_PAGE_BUILDER_PATH; ?>img/mrare.png">
		<p>
	...
	<div class="vhw vjr">
			...
			<div class="vqh vih vaw vfq vav">Sort Next</div>
			<div class="vqi vih vaw vfq vav">Sort Previous</div>
	...
	<div id="vgg" class="vih">
		<?php do_action('variant_print_sections'); ?>
	</div>
	...
	<?php do_action('variant_print_json'); ?>
